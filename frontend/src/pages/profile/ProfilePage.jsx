...
import { FaLeaf, FaLink } from "react-icons/fa";
...
const ProfilePage = () => {
    ...
    const { updateProfile, isUpdatingProfile } = useUserUpdateProfile();
    ...
    const { data: user, isLoading, refetch: refetchUser, isRefetching } = useQuery({
